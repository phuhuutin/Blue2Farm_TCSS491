class Portal {
    ...
    updateBB(){
        ...
        this.BB = new BoundingBox(this.x - this.game.camera.x , this.y + 2350 - this.game.camera.y ,100, 120)
 ...
 // if(this.state==0 ){
    ...
    this.animations[0][0].drawFrame(this.game.clockTick, ctx, this.x -40 - this.game.camera.x, this.y + 2320 - this.game.camera.y, 0.5);
    if (PARAMS.DEBUG) {
        ctx.strokeStyle = 'red';
        // ctx.strokeRect( this.BB.x - (this.game.camera.x+200), this.BB.y -this.game.camera.y-190 , this.BB.width+250, this.BB.height + 310);
        ctx.strokeRect(this.x - this.game.camera.x, this.y+ 2350 -this.game.camera.y, 100, 120);
