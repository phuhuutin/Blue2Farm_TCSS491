class GreenGoblin {
  constructor(game, x, y, path) {
      ...
      this.spritesheet = ASSET_MANAGER.getAsset("./sprites/enemy/greengoblin.png");
      this.spritesheet2 = ASSET_MANAGER.getAsset("./sprites/enemy/greengoblin_attack.png");
      this.targetID = 0;
...
if(this.state==0 ){
  this.animations[0][0].drawFrame(this.game.clockTick, ctx, this.x -20 - this.game.camera.x, this.y - 30 - this.game.camera.y, 1);

}
else if( this.state==1 && this.faceleft ==true){
  ctx.save();
ctx.scale(-1, 1);
this.animations[1][0].drawFrame(this.game.clockTick, ctx, -this.x -20 + this.game.camera.x, this.y - 30 - this.game.camera.y, 1);
ctx.restore();

}
else if( this.state==1 && this.faceleft ==false){
  this.animations[this.state][0].drawFrame(this.game.clockTick, ctx, this.x -20  - this.game.camera.x, this.y - 30 - this.game.camera.y, 1);
