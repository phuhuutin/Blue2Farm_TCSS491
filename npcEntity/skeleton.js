class Skeleton {
  ...
  if(this.state==0 ){
    this.animations[0][0].drawFrame(this.game.clockTick, ctx, this.x -50 - this.game.camera.x, this.y - 50 - this.game.camera.y, 1.5);

  }
  else if( this.state==1 && this.faceleft ==true){
    ctx.save();
ctx.scale(-1, 1);
this.animations[1][0].drawFrame(this.game.clockTick, ctx, -this.x-50 + this.game.camera.x, this.y - 50 - this.game.camera.y, 1.5);
ctx.restore();

  }
  else if( this.state==1 && this.faceleft ==false){
    this.animations[this.state][0].drawFrame(this.game.clockTick, ctx, this.x -50 - this.game.camera.x, this.y - 50 - this.game.camera.y, 1.5);
